...
ostream& operator<<(ostream& os, const rational_t&); //AQUI SE SOBRECARGA EL OPERADOR <<
istream& operator>>(istream& is, rational_t&);  //AQUI SE SOBRECARGA EL OPERADOR >>

// FASE I: operadores
rational_t operator+(const rational_t&, const rational_t&); //AQUI SE SOBRECARGA EL OPERADOR +
rational_t operator-(const rational_t&, const rational_t&); //AQUI SE SOBRECARGA EL OPERADOR -
rational_t operator*(const rational_t&, const rational_t&); //AQUI SE SOBRECARGA EL OPERADOR *
rational_t operator/(const rational_t&, const rational_t&); //AQUI SE SOBRECARGA EL OPERADOR /
