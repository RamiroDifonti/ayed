...
public:
  ...
  // elimina todos los elementos del conjunto
	...
	//MODIS
	void universal(void);
	void complemento(void);
	void nand(const bitset_t& bs, bitset_t& result)const;
	void nor(const bitset_t& bs, bitset_t& result)const;
	double valor_medio(void);
	void cartesiano(const bitset_t& bs)const ;
